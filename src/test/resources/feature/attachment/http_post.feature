...
Feature: HTTP POST
    ...
    Scenario Outline: HTTP Post verb.
        ...
        When I perform a HTTP "POST" request to the last response "Location" header value with headers "Content-Type: text/html, Accept: application/json":
        """
        " Message attachment data for recipient. "
        """
