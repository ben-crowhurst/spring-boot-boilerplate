...
Feature: HTTP TRACE
    ...
    Scenario Outline: HTTP Trace verb.
        ...
        """
        " { "meta": {                                                                           "
        "     "key": "2d42725c-188b-491f-aa54-6ab29230dde9"                                     "
        "   },                                                                                  "
        "   "data": {                                                                           "
        "     "to": "ben.crowhurst@outlook.com",                                                "
        "     "from": "ben.crowhurst@hotmail.com",                                              "
        "     "message": "If the opposite of pro is con, is the opposite of progress congress?" "
        "   }                                                                                   "
        " }                                                                                     "
        """
        And I should see a response status code of "201" "Accepted"
        When I perform a HTTP "TRACE" request to "/messages/2d42725c-188b-491f-aa54-6ab29230dde9" with headers "Accept: application/json"
