...
Feature: HTTP CONNECT
    In order to restrict the HTTP methods implemented
    As a resource owner
    I want to disallow the HTTP CONNECT method

    Scenario Outline: HTTP Connect verb.
        ...
        """
        " { "meta": {                                                             "
        "     "key": "49bc391d-0b0f-4ea2-9fb1-790ebc88eeb6"                       "
        "   },                                                                    "
        "   "data": {                                                             "
        "     "to": "ben.crowhurst@outlook.com",                                  "
        "     "from": "ben.crowhurst@hotmail.com",                                "
        "     "message": "If Tomatoes are fruits, then isn't ketchup a smoothie?" "
        "   }                                                                     "
        " }                                                                       "
        """
        And I should see a response status code of "201" "Accepted"
        When I perform a HTTP "CONNECT" request to "/messages/49bc391d-0b0f-4ea2-9fb1-790ebc88eeb6" with headers "Accept: application/json"
