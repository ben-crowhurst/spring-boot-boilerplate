...
Feature: HTTP PUT
    ...
    Scenario Outline: HTTP Put verb.
        ...
        """
        " { "meta": {                                                                                        "
        "     "key": "bf154100-229d-44cb-ae3d-0949b3402a1d"                                                  "
        "   },                                                                                               "
        "   "data": {                                                                                        "
        ...
        When I perform a HTTP "PUT" request to "/messages/bf154100-229d-44cb-ae3d-0949b3402a1d" with headers "Accept: application/json, Content-Type: application/json":
        """
        " { "data": { } } "
        """
